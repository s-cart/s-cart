...
return [
    ...
    'extensions_more' => '<a href="https://s-cart.org/plugin.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Tải thêm TẠI ĐÂY</a>',
    ...
    'plugin_manager' =>  [
        ...
        'Payment'     => 'Thanh toán <span class="badge label label-primary">' . count(sc_get_all_plugin('Payment')) . '</span>',
        'Payment_plugin'     => 'Chức năng thanh toán',
        'Total'       => 'Tổng đơn hàng <span class="badge label label-primary">' . count(sc_get_all_plugin('Total')) . '</span>',
        'Total_plugin'       => 'Chức năng tổng đơn hàng',
        'Other'       => 'Chức năng khác <span class="badge label label-primary">' . count(sc_get_all_plugin('Other')) . '</span>',
        'Other_plugin'       => 'Chức năng khác',
        'Cms' => 'Module CMS <span class="badge label label-primary">' . count(sc_get_all_plugin('Cms')) . '</span>',
        'Cms_plugin' => 'Module CMS',
        'Api' => 'Module Api <span class="badge label label-primary">' . count(sc_get_all_plugin('Api')) . '</span>',
