              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <!--Brand--><a class="brand" href="{{ sc_route('home') }}"><img class="brand-logo-dark" src="{{ sc_file($logo ?? sc_store('logo')) }}" alt="" width="105" height="44"/>
                      <img class="brand-logo-light" src="{{ sc_file($logo ?? sc_store('logo')) }}" alt="" width="106" height="44"/></a>
                  </div>
                </div>
