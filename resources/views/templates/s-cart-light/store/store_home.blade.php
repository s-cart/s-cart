                  ...
                  <div class="col-sm-6 col-md-4">
                      ...
                      <article class="product wow fadeInRight">
                        <div class="product-body">
                          ...
                          <a onClick="addToCartAjax('{{ $product->id }}','default', '{{ $product->store_id }}')" class="button button-secondary button-zakaria add-to-cart-list"><i class="fa fa-cart-plus"></i> {{sc_language_render('action.add_to_cart')}}</a>
                          @endif
                          {{--// Button add to cart --}}
