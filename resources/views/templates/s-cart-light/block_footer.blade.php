      ...
      <footer class="section footer-classic">
        <div class="footer-classic-body section-sm bg-brown-2">
          <div class="container-fluid footer-fix-container">
            <div class="row row-40 row-md-50 justify-content-xl-between">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-3 wow fadeInRight footer-fix-about-us" data-wow-delay=".1s">
                <h4 class="footer-classic-title">{{ sc_language_render('about.page_title') }}</h4>
                <ul class="contacts-creative footer-fix-address footer-fix-title">
                  <li>
              ...
              <div class="col-lg-4 wow fadeInRight footer-fix-profile" data-wow-delay=".2s">
                <h4 class="footer-classic-title"> {{ sc_language_render('front.my_profile') }}</h4>
                <!-- RD Mailform-->
                <ul class="contacts-creative footer-fix-title">
