    ...
    <section class="section section-sm section-first bg-default">
        <div class="container">
            ...
            <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-1">
                ...
                {{-- Calculate content length without HTML tags --}}
                @php
                    $content = $product->content;
                    $contentLength = strlen(strip_tags($content)); // Calculate the length without HTML tags
                @endphp
                <div class="tab-content tab-content-1">
                    <div class="tab-pane fade show active" id="tabs-1-1">
                        @if ($contentLength > 200)
                            <div id="content-container">
                                <div id="visible-content">{!! substr($content, 0, 200) !!}</div>
                                <div id="hidden-content" style="display: none;">{!! substr($content, 200) !!}</div>
                                <a id="see-more-button" class="see-more-button">...See more</a>
