...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <form action="{{ route('admin_template.process_import') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-product" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    ...
                                    <div class="btn input-group-addon button-upload">
                                        <i class="fa fa-floppy-o" aria-hidden="true"></i> {{ trans('template.import_submit') }}
                                    </div>
                                </div>
                                <div>
                                    @if ($errors->has('file'))
                                    ...
                                    @else
                                    <span class="help-block">
                                        <i class="fa fa-info-circle"></i> {!! trans('template.import_note') !!}
                                    </span>
                                    @endif
                                </div>
                            </div>
