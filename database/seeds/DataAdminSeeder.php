...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_menu')->insert(
            ...
            ['id' => 51, 'parent_id' => 2, 'sort' => 10, 'title' => 'lang::sub_category.admin.title', 'icon' => 'far fa-folder', 'uri' => 'admin::sub_category', 'key' => null, 'type' => 0],
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_permission')->insert(
            ...
            ['id' => '13', 'name' => 'Sub category', 'slug' => 'sub_category','http_uri' => 'ANY::'.SC_ADMIN_PREFIX.'/sub_category/*','created_at' => date('Y-m-d H:i:s')],
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_config')->insert(
            ...
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_sub_category', 'value' => '0', 'sort' => '3', 'detail' => 'lang::cache.config_manager.cache_sub_category', 'store_id' => 0],
