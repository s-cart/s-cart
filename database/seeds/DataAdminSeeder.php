...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table(SC_DB_PREFIX.'admin_config')->insert(
            ...
            ['group' => 'all', 'code' => 'config_other', 'key' => 'domain_strict', 'value' => '0', 'sort' => '1', 'detail' => 'lang::config.domain_strict'],
            ...
            ['group' => '', 'code' => 'smtp', 'key' => 'smtp_host', 'value' => '', 'sort' => '1', 'detail' => 'lang::email.smtp_host'],
            ['group' => '', 'code' => 'smtp', 'key' => 'smtp_user', 'value' => '', 'sort' => '2', 'detail' => 'lang::email.smtp_user'],
            ['group' => '', 'code' => 'smtp', 'key' => 'smtp_password', 'value' => '', 'sort' => '3', 'detail' => 'lang::email.smtp_password'],
            ['group' => '', 'code' => 'smtp', 'key' => 'smtp_security', 'value' => '', 'sort' => '4', 'detail' => 'lang::email.smtp_security'],
            ['group' => '', 'code' => 'smtp', 'key' => 'smtp_port', 'value' => '', 'sort' => '5', 'detail' => 'lang::email.smtp_port'],
