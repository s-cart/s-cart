...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_permission')->insert(
            ...
            ['id' => '4', 'name' => 'Setting manager', 'slug' => 'config.full', 'http_uri' => 'ANY::'.SC_ADMIN_PREFIX.'/store/*,ANY::'.SC_ADMIN_PREFIX.'/config/*,ANY::'.SC_ADMIN_PREFIX.'/store_config/*,ANY::'.SC_ADMIN_PREFIX.'/cache_config/*,ANY::'.SC_ADMIN_PREFIX.'/email_template/*,ANY::'.SC_ADMIN_PREFIX.'/language/*,ANY::'.SC_ADMIN_PREFIX.'/currency/*,ANY::'.SC_ADMIN_PREFIX.'/backup/*,ANY::'.SC_ADMIN_PREFIX.'/api_connection/*,ANY::'.SC_ADMIN_PREFIX.'/maintain/*,ANY::'.SC_ADMIN_PREFIX.'/tax/*','created_at' => date('Y-m-d H:i:s')],
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_role')->insert(
            ...
            ['id' => '3', 'name' => 'Seller', 'slug' => 'seller', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '4', 'name' => 'Manager', 'slug' => 'manager', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '5', 'name' => 'Cms manager', 'slug' => 'cms', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '6', 'name' => 'Accountant', 'slug' => 'accountant', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '7', 'name' => 'Marketing', 'slug' => 'maketing', 'created_at' => date('Y-m-d H:i:s')]]
        );
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_role_permission')->insert(
            ...
            ['role_id' => 4, 'permission_id' => 17, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 2, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 11, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 20, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 18, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 15, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 19, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 21, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 4, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 22, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 4, 'permission_id' => 14, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 5, 'permission_id' => 3, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 5, 'permission_id' => 8, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 5, 'permission_id' => 5, 'created_at' => date('Y-m-d H:i:s')],
            ...
            ['role_id' => 7, 'permission_id' => 5, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 3, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 8, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 17, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 2, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 11, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 20, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 15, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 19, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 21, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 14, 'created_at' => date('Y-m-d H:i:s')],
            ['role_id' => 7, 'permission_id' => 18, 'created_at' => date('Y-m-d H:i:s')],
            ]
        );
