...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_menu')->insert(
            ...
            ['id' => 8, 'parent_id' => 0, 'sort' => 300, 'title' => 'lang::admin.ADMIN_EXTENSION', 'icon' => 'fas fa-cog', 'uri' => '', 'key' => 'ADMIN_EXTENSION', 'type' => 0],
            ['id' => 9, 'parent_id' => 0, 'sort' => 400, 'title' => 'lang::admin.ADMIN_SYSTEM', 'icon' => 'fas fa-cog', 'uri' => '', 'key' => 'ADMIN_SYSTEM', 'type' => 0],
            ...
            ['id' => 65, 'parent_id' => 0, 'sort' => 200, 'title' => 'lang::admin.menu_titles.store_manager', 'icon' => 'fas fa-store-alt', 'uri' => '', 'key' => 'STORE_MANAGER', 'type' => 0],
