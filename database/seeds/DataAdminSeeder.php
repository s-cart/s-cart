...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_menu')->insert(
            ...
            ['id' => 57, 'parent_id' => 65, 'sort' => 4, 'title' => 'lang::admin.menu_titles.config_store_default', 'icon' => 'fas fa-cog', 'uri' => 'admin::config_store_default', 'key' => null, 'type' => 0],
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_permission')->insert(
            ...
            ['id' => '4', 'name' => 'Setting manager', 'slug' => 'config.full', 'http_uri' => 'ANY::'.SC_ADMIN_PREFIX.'/store/*,ANY::'.SC_ADMIN_PREFIX.'/config/*,ANY::'.SC_ADMIN_PREFIX.'/config_store_default/*,ANY::'.SC_ADMIN_PREFIX.'/cache_config/*,ANY::'.SC_ADMIN_PREFIX.'/email_template/*,ANY::'.SC_ADMIN_PREFIX.'/language/*,ANY::'.SC_ADMIN_PREFIX.'/currency/*,ANY::'.SC_ADMIN_PREFIX.'/backup/*,ANY::'.SC_ADMIN_PREFIX.'/api_connection/*,ANY::'.SC_ADMIN_PREFIX.'/maintain/*,ANY::'.SC_ADMIN_PREFIX.'/tax/*','created_at' => date('Y-m-d H:i:s')],
