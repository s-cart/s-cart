...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table(SC_DB_PREFIX.'admin_menu')->insert([
            ...
            ['id' => 32, 'parent_id' => 30, 'sort' => 0, 'title' => 'lang::currency.admin.title', 'icon' => 'fas fa-dollar', 'uri' => 'admin::currency', 'key' => null, 'type' => 0],
            ...
            ['id' => 63, 'parent_id' => 2, 'sort' => 6, 'title' => 'lang::length.admin.title', 'icon' => 'fas fas fa-cog', 'uri' => 'admin::length_unit', 'key' => null, 'type' => 0],
