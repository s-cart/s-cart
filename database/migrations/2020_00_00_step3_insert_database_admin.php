...
class InsertDatabaseAdmin extends Migration
{
    ...
    public function up()
    {
        DB::table(SC_DB_PREFIX.'admin_menu')->insert([
            ...
            ['id' => 35, 'parent_id' => 8, 'sort' => 202, 'title' => 'lang::admin.menu_titles.plugins', 'icon' => 'fa-puzzle-piece', 'uri' => '', 'type' => 0],
            ...
            ['id' => 39, 'parent_id' => 35, 'sort' => 0, 'title' => 'admin.plugin_manager.Payment', 'icon' => 'fa-money', 'uri' => 'admin::plugin/payment', 'type' => 0],
            ['id' => 40, 'parent_id' => 35, 'sort' => 0, 'title' => 'admin.plugin_manager.Shipping', 'icon' => 'fa-ambulance', 'uri' => 'admin::plugin/shipping', 'type' => 0],
            ['id' => 41, 'parent_id' => 35, 'sort' => 0, 'title' => 'admin.plugin_manager.Total', 'icon' => 'fa-cog', 'uri' => 'admin::plugin/total', 'type' => 0],
            ['id' => 42, 'parent_id' => 35, 'sort' => 100, 'title' => 'admin.plugin_manager.Other', 'icon' => 'fa-circle-thin', 'uri' => 'admin::plugin/other', 'type' => 0],
            ['id' => 43, 'parent_id' => 35, 'sort' => 0, 'title' => 'admin.plugin_manager.Cms', 'icon' => 'fa-modx', 'uri' => 'admin::plugin/cms', 'type' => 0],
            ...
            ['id' => 53, 'parent_id' => 5, 'sort' => 3, 'title' => 'lang::setting.title', 'icon' => 'fa-cog', 'uri' => 'admin::setting', 'type' => 0],
            ...
            ['id' => 59, 'parent_id' => 9, 'sort' => 303, 'title' => 'lang::admin.menu_titles.api_manager', 'icon' => 'fa-plug', 'uri' => 'admin::api_connection', 'type' => 0],
            ['id' => 60, 'parent_id' => 5, 'sort' => 3, 'title' => 'lang::maintain.config_manager.title', 'icon' => 'fa-flag', 'uri' => 'admin::maintain', 'type' => 0],
        ...
        DB::table(SC_DB_PREFIX.'admin_store')->insert(
            ['logo' => '/data/logo/scart-mid.png', 'site_status' => 1, 'template' => 'new2', 'phone' => '0123456789', 'long_phone' => 'Support: 0987654321', 'email' => 'admin-demo@s-cart.org', 'time_active' => '', 'address' => '123st - abc - xyz']
        );
