...
class InsertDatabaseAdmin extends Migration
{
    ...
    public function up()
    {
        DB::table(SC_DB_PREFIX.'admin_menu')->insert([
            ...
            ['id' => 39, 'parent_id' => 35, 'sort' => 0, 'title' => 'plugin.Payment', 'icon' => 'fa-money', 'uri' => 'admin::plugin/payment', 'type' => 0],
            ['id' => 40, 'parent_id' => 35, 'sort' => 0, 'title' => 'plugin.Shipping', 'icon' => 'fa-ambulance', 'uri' => 'admin::plugin/shipping', 'type' => 0],
            ['id' => 41, 'parent_id' => 35, 'sort' => 0, 'title' => 'plugin.Total', 'icon' => 'fa-cog', 'uri' => 'admin::plugin/total', 'type' => 0],
            ['id' => 42, 'parent_id' => 35, 'sort' => 100, 'title' => 'plugin.Other', 'icon' => 'fa-circle-thin', 'uri' => 'admin::plugin/other', 'type' => 0],
            ['id' => 43, 'parent_id' => 35, 'sort' => 0, 'title' => 'plugin.Cms', 'icon' => 'fa-modx', 'uri' => 'admin::plugin/cms', 'type' => 0],
