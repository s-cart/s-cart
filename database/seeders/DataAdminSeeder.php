...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_menu')->insert(
            ...
            ['id' => 10, 'parent_id' => 7, 'sort' => 102, 'title' => 'page.admin.title', 'icon' => 'fas fa-clone', 'uri' => 'admin::page', 'key' => null, 'type' => 0],
            ['id' => 11, 'parent_id' => 27, 'sort' => 2, 'title' => 'shipping_status.admin.title', 'icon' => 'fas fa-truck', 'uri' => 'admin::shipping_status', 'key' => null, 'type' => 0],
            ['id' => 12, 'parent_id' => 1, 'sort' => 3, 'title' => 'order.admin.title', 'icon' => 'fas fa-shopping-cart', 'uri' => 'admin::order', 'key' => null, 'type' => 0],
            ['id' => 13, 'parent_id' => 27, 'sort' => 1, 'title' => 'order_status.admin.title', 'icon' => 'fas fa-asterisk', 'uri' => 'admin::order_status', 'key' => null, 'type' => 0],
            ['id' => 14, 'parent_id' => 27, 'sort' => 3, 'title' => 'payment_status.admin.title', 'icon' => 'fas fa-recycle', 'uri' => 'admin::payment_status', 'key' => null, 'type' => 0],
            ['id' => 15, 'parent_id' => 2, 'sort' => 0, 'title' => 'product.admin.title', 'icon' => 'far fa-file-image', 'uri' => 'admin::product', 'key' => null, 'type' => 0],
            ['id' => 16, 'parent_id' => 2, 'sort' => 0, 'title' => 'category.admin.title', 'icon' => 'fas fa-folder-open', 'uri' => 'admin::category', 'key' => null, 'type' => 0],
            ['id' => 17, 'parent_id' => 27, 'sort' => 4, 'title' => 'supplier.admin.title', 'icon' => 'fas fa-user-secret', 'uri' => 'admin::supplier', 'key' => null, 'type' => 0],
            ['id' => 18, 'parent_id' => 27, 'sort' => 5, 'title' => 'brand.admin.title', 'icon' => 'fas fa-university', 'uri' => 'admin::brand', 'key' => null, 'type' => 0],
            ['id' => 19, 'parent_id' => 27, 'sort' => 8, 'title' => 'attribute_group.admin.title', 'icon' => 'fas fa-bars', 'uri' => 'admin::attribute_group', 'key' => null, 'type' => 0],
            ['id' => 20, 'parent_id' => 3, 'sort' => 0, 'title' => 'customer.admin.title', 'icon' => 'fas fa-user', 'uri' => 'admin::customer', 'key' => null, 'type' => 0],
            ['id' => 21, 'parent_id' => 3, 'sort' => 0, 'title' => 'subscribe.admin.title', 'icon' => 'fas fa-user-circle', 'uri' => 'admin::subscribe', 'key' => null, 'type' => 0],
            ['id' => 22, 'parent_id' => 67, 'sort' => 1, 'title' => 'store_block.admin.title', 'icon' => 'far fa-newspaper', 'uri' => 'admin::store_block', 'key' => null, 'type' => 0],
            ['id' => 23, 'parent_id' => 67, 'sort' => 2, 'title' => 'admin.menu_titles.block_link', 'icon' => 'fab fa-chrome', 'uri' => 'admin::store_link', 'key' => null, 'type' => 0],
            ['id' => 24, 'parent_id' => 4, 'sort' => 0, 'title' => 'admin.menu_titles.template_manager', 'icon' => 'fas fa-columns', 'uri' => 'admin::template', 'key' => null, 'type' => 0],
            ['id' => 25, 'parent_id' => 0, 'sort' => 200, 'title' => 'admin.menu_titles.ADMIN_MARKETING', 'icon' => 'fas fa-sort-amount-up', 'uri' => '', 'key' => 'MARKETING', 'type' => 0],
            ['id' => 26, 'parent_id' => 65, 'sort' => 1, 'title' => 'store.admin.title', 'icon' => 'fas fa-h-square', 'uri' => 'admin::store_info', 'key' => null, 'type' => 0],
            ...
            ['id' => 29, 'parent_id' => 25, 'sort' => 0, 'title' => 'email_template.admin.title', 'icon' => 'fas fa-bars', 'uri' => 'admin::email_template', 'key' => null, 'type' => 0],
            ['id' => 30, 'parent_id' => 9, 'sort' => 5, 'title' => 'admin.menu_titles.localisation', 'icon' => 'fab fa-shirtsinbulk', 'uri' => '', 'key' => null, 'type' => 0],
            ['id' => 31, 'parent_id' => 30, 'sort' => 0, 'title' => 'language.admin.title', 'icon' => 'fas fa-language', 'uri' => 'admin::language', 'key' => null, 'type' => 0],
            ['id' => 32, 'parent_id' => 30, 'sort' => 0, 'title' => 'currency.admin.title', 'icon' => 'far fa-money-bill-alt', 'uri' => 'admin::currency', 'key' => null, 'type' => 0],
            ['id' => 33, 'parent_id' => 7, 'sort' => 101, 'title' => 'banner.admin.title', 'icon' => 'fas fa-image', 'uri' => 'admin::banner', 'key' => null, 'type' => 0],
            ['id' => 34, 'parent_id' => 5, 'sort' => 5, 'title' => 'backup.admin.title', 'icon' => 'fas fa-save', 'uri' => 'admin::backup', 'key' => null, 'type' => 0],
            ['id' => 35, 'parent_id' => 8, 'sort' => 202, 'title' => 'admin.menu_titles.plugins', 'icon' => 'fas fa-puzzle-piece', 'uri' => '', 'key' => 'PLUGIN', 'type' => 0],
            ...
            ['id' => 44, 'parent_id' => 67, 'sort' => 2, 'title' => 'admin.menu_titles.css', 'icon' => 'far fa-file-code', 'uri' => 'admin::store_css', 'key' => null, 'type' => 0],
            ...
            ['id' => 52, 'parent_id' => 7, 'sort' => 103, 'title' => 'news.admin.title', 'icon' => 'far fa-file-powerpoint', 'uri' => 'admin::news', 'key' => null, 'type' => 0],
            ['id' => 53, 'parent_id' => 5, 'sort' => 0, 'title' => 'admin.menu_titles.env_config', 'icon' => 'fas fa-tasks', 'uri' => 'admin::env/config', 'key' => null, 'type' => 0],
            ...
            ['id' => 60, 'parent_id' => 65, 'sort' => 3, 'title' => 'store_maintain.config_manager.title', 'icon' => 'fas fa-wrench', 'uri' => 'admin::store_maintain', 'key' => null, 'type' => 0],
            ['id' => 61, 'parent_id' => 27, 'sort' => 9, 'title' => 'tax.admin.admin_title', 'icon' => 'far fa-calendar-minus', 'uri' => 'admin::tax', 'key' => null, 'type' => 0],
            ['id' => 62, 'parent_id' => 27, 'sort' => 6, 'title' => 'weight.admin.title', 'icon' => 'fas fa-balance-scale', 'uri' => 'admin::weight_unit', 'key' => null, 'type' => 0],
            ['id' => 63, 'parent_id' => 27, 'sort' => 7, 'title' => 'length.admin.title', 'icon' => 'fas fa-minus', 'uri' => 'admin::length_unit', 'key' => null, 'type' => 0],
            ...
            ['id' => 68, 'parent_id' => 27, 'sort' => 5, 'title' => 'custom_field.admin.title', 'icon' => 'fa fa-american-sign-language-interpreting', 'uri' => 'admin::custom_field', 'key' => null, 'type' => 0],
            ]
        );
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_config')->insert(
            ...
            ['group' => 'global', 'code' => 'env_global', 'key' => 'ADMIN_LOG', 'value' => 'on', 'sort' => '0', 'detail' => 'env.ADMIN_LOG', 'store_id' => 0],
            ['group' => 'global', 'code' => 'env_global', 'key' => 'ADMIN_LOG_EXP', 'value' => '', 'sort' => '0', 'detail' => 'env.ADMIN_LOG_EXP', 'store_id' => 0],
            ['group' => 'global', 'code' => 'env_global', 'key' => 'ADMIN_FOOTER_OFF', 'value' => '0', 'sort' => '0', 'detail' => 'env.ADMIN_FOOTER_OFF', 'store_id' => 0],
            ['group' => 'global', 'code' => 'seo_config', 'key' => 'url_seo_lang', 'value' => '0', 'sort' => '1', 'detail' => 'seo.url_seo_lang', 'store_id' => 0],
            ['group' => 'global', 'code' => 'webhook_config', 'key' => 'LOG_SLACK_WEBHOOK_URL', 'value' => '', 'sort' => '0', 'detail' => 'config.LOG_SLACK_WEBHOOK_URL', 'store_id' => 0],
            ['group' => 'global', 'code' => 'webhook_config', 'key' => 'GOOGLE_CHAT_WEBHOOK_URL', 'value' => '', 'sort' => '0', 'detail' => 'config.GOOGLE_CHAT_WEBHOOK_URL', 'store_id' => 0],
            ['group' => 'global', 'code' => 'webhook_config', 'key' => 'CHATWORK_CHAT_WEBHOOK_URL', 'value' => '', 'sort' => '0', 'detail' => 'config.CHATWORK_CHAT_WEBHOOK_URL', 'store_id' => 0],
            ...
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_status', 'value' => '0', 'sort' => '0', 'detail' => 'cache.config_manager.cache_status', 'store_id' => 0],
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_time', 'value' => '600', 'sort' => '0', 'detail' => 'cache.config_manager.cache_time', 'store_id' => 0],
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_category', 'value' => '0', 'sort' => '3', 'detail' => 'cache.config_manager.cache_category', 'store_id' => 0],
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_product', 'value' => '0', 'sort' => '4', 'detail' => 'cache.config_manager.cache_product', 'store_id' => 0],
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_news', 'value' => '0', 'sort' => '5', 'detail' => 'cache.config_manager.cache_news', 'store_id' => 0],
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_category_cms', 'value' => '0', 'sort' => '6', 'detail' => 'cache.config_manager.cache_category_cms', 'store_id' => 0],
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_content_cms', 'value' => '0', 'sort' => '7', 'detail' => 'cache.config_manager.cache_content_cms', 'store_id' => 0],
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_page', 'value' => '0', 'sort' => '8', 'detail' => 'cache.config_manager.cache_page', 'store_id' => 0],
            ['group' => 'global', 'code' => 'cache', 'key' => 'cache_country', 'value' => '0', 'sort' => '10', 'detail' => 'cache.config_manager.cache_country', 'store_id' => 0],
