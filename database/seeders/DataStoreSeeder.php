...
class DataStoreSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_config')->insertOrIgnore(
            ...
            ['group' => '', 'code' => 'product_config', 'key' => 'product_display_out_of_stock', 'value' => '1', 'sort' => '19', 'detail' => 'admin.product_display_out_of_stock', 'store_id' => $storeId],
            ['group' => '', 'code' => 'product_config', 'key' => 'show_date_available', 'value' => '1', 'sort' => '21', 'detail' => 'admin.show_date_available', 'store_id' => $storeId],
            ...
            ['group' => '', 'code' => 'admin_config', 'key' => 'ADMIN_NAME', 'value' => 'S-Cart System', 'sort' => '0', 'detail' => 'env.ADMIN_NAME', 'store_id' => $storeId],
            ['group' => '', 'code' => 'admin_config', 'key' => 'ADMIN_TITLE', 'value' => 'S-Cart Admin', 'sort' => '0', 'detail' => 'env.ADMIN_TITLE', 'store_id' => $storeId],
            ['group' => '', 'code' => 'admin_config', 'key' => 'ADMIN_LOGO', 'value' => 'S-Cart <span class="brand-text font-weight-light">Admin</span>', 'sort' => '0', 'detail' => 'env.ADMIN_LOGO', 'store_id' => $storeId],


            ['group' => '', 'code' => 'display_config', 'key' => 'product_top', 'value' => '8', 'sort' => '0', 'detail' => 'admin.product_top', 'store_id' => $storeId],
            ['group' => '', 'code' => 'display_config', 'key' => 'product_list', 'value' => '12', 'sort' => '0', 'detail' => 'admin.list_product', 'store_id' => $storeId],
            ['group' => '', 'code' => 'display_config', 'key' => 'product_relation', 'value' => '4', 'sort' => '0', 'detail' => 'admin.relation_product', 'store_id' => $storeId],
            ['group' => '', 'code' => 'display_config', 'key' => 'product_viewed', 'value' => '4', 'sort' => '0', 'detail' => 'admin.viewed_product', 'store_id' => $storeId],
            ['group' => '', 'code' => 'display_config', 'key' => 'item_list', 'value' => '12', 'sort' => '0', 'detail' => 'admin.item_list', 'store_id' => $storeId],
            ['group' => '', 'code' => 'display_config', 'key' => 'item_top', 'value' => '8', 'sort' => '0', 'detail' => 'admin.item_top', 'store_id' => $storeId],
            ...
            ['group' => '', 'code' => 'smtp_config', 'key' => 'smtp_host', 'value' => '', 'sort' => '1', 'detail' => 'email.smtp_host', 'store_id' => $storeId],
            ['group' => '', 'code' => 'smtp_config', 'key' => 'smtp_user', 'value' => '', 'sort' => '2', 'detail' => 'email.smtp_user', 'store_id' => $storeId],
            ['group' => '', 'code' => 'smtp_config', 'key' => 'smtp_password', 'value' => '', 'sort' => '3', 'detail' => 'email.smtp_password', 'store_id' => $storeId],
            ['group' => '', 'code' => 'smtp_config', 'key' => 'smtp_security', 'value' => '', 'sort' => '4', 'detail' => 'email.smtp_security', 'store_id' => $storeId],
            ['group' => '', 'code' => 'smtp_config', 'key' => 'smtp_port', 'value' => '', 'sort' => '5', 'detail' => 'email.smtp_port', 'store_id' => $storeId],
            ['group' => '', 'code' => 'smtp_config', 'key' => 'smtp_name', 'value' => '', 'sort' => '6', 'detail' => 'email.smtp_name', 'store_id' => $storeId],
            ['group' => '', 'code' => 'smtp_config', 'key' => 'smtp_from', 'value' => '', 'sort' => '7', 'detail' => 'email.smtp_from', 'store_id' => $storeId],

            ['group' => '', 'code' => 'url_config', 'key' => 'SUFFIX_URL', 'value' => '.html', 'sort' => '0', 'detail' => 'url.SUFFIX_URL', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_SHOP', 'value' => 'shop', 'sort' => '0', 'detail' => 'env.PREFIX_SHOP', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_BRAND', 'value' => 'brand', 'sort' => '0', 'detail' => 'env.PREFIX_BRAND', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_CATEGORY', 'value' => 'category', 'sort' => '0', 'detail' => 'env.PREFIX_CATEGORY', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_SUB_CATEGORY', 'value' => 'sub-category', 'sort' => '0', 'detail' => 'env.PREFIX_SUB_CATEGORY', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_PRODUCT', 'value' => 'product', 'sort' => '0', 'detail' => 'env.PREFIX_PRODUCT', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_SEARCH', 'value' => 'search', 'sort' => '0', 'detail' => 'env.PREFIX_SEARCH', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_CONTACT', 'value' => 'contact', 'sort' => '0', 'detail' => 'env.PREFIX_CONTACT', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_NEWS', 'value' => 'news', 'sort' => '0', 'detail' => 'env.PREFIX_NEWS', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_MEMBER', 'value' => 'customer', 'sort' => '0', 'detail' => 'env.PREFIX_MEMBER', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_MEMBER_ORDER_LIST', 'value' => 'order-list', 'sort' => '0', 'detail' => 'env.PREFIX_MEMBER_ORDER_LIST', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_MEMBER_CHANGE_PWD', 'value' => 'change-password', 'sort' => '0', 'detail' => 'env.PREFIX_MEMBER_CHANGE_PWD', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_MEMBER_CHANGE_INFO', 'value' => 'change-info', 'sort' => '0', 'detail' => 'env.PREFIX_MEMBER_CHANGE_INFO', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_CMS_CATEGORY', 'value' => 'cms-category', 'sort' => '0', 'detail' => 'env.PREFIX_CMS_CATEGORY', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_CMS_ENTRY', 'value' => 'entry', 'sort' => '0', 'detail' => 'env.PREFIX_CMS_ENTRY', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_CART_WISHLIST', 'value' => 'wishlst', 'sort' => '0', 'detail' => 'env.PREFIX_CART_WISHLIST', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_CART_COMPARE', 'value' => 'compare', 'sort' => '0', 'detail' => 'env.PREFIX_CART_COMPARE', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_CART_DEFAULT', 'value' => 'cart', 'sort' => '0', 'detail' => 'env.PREFIX_CART_DEFAULT', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_CART_CHECKOUT', 'value' => 'checkout', 'sort' => '0', 'detail' => 'env.PREFIX_CART_CHECKOUT', 'store_id' => $storeId],
            ['group' => '', 'code' => 'url_config', 'key' => 'PREFIX_ORDER_SUCCESS', 'value' => 'order-success', 'sort' => '0', 'detail' => 'env.PREFIX_ORDER_SUCCESS', 'store_id' => $storeId],
            
            ['group' => '', 'code' => 'captcha_config', 'key' => 'captcha_mode', 'value' => '0', 'sort' => '20', 'detail' => 'captcha.captcha_mode', 'store_id' => $storeId],
            ['group' => '', 'code' => 'captcha_config', 'key' => 'captcha_page', 'value' => '[]', 'sort' => '10', 'detail' => 'captcha.captcha_page', 'store_id' => $storeId],
            ['group' => '', 'code' => 'captcha_config', 'key' => 'captcha_method', 'value' => '', 'sort' => '0', 'detail' => 'captcha.captcha_method', 'store_id' => $storeId],
