...
class AdminProductPropertyController extends RootAdminController
{
    ...
    {
        $data = [
            'title' => sc_language_render('admin.product_property.list'),
            'title_action' => '<i class="fa fa-plus" aria-hidden="true"></i> ' . sc_language_render('admin.product_property.add_new_title'),
            'subTitle' => '',
            'icon' => 'fa fa-indent',
        ...
        $listTh = [
            'code' => sc_language_render('admin.product_property.code'),
            'name' => sc_language_render('admin.product_property.name'),
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[$row['id']] = [
                ...
                'name' => $row['name'] ?? 'N/A',
                'action' => '
                    <a href="' . sc_route_admin('admin_product_property.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '"><span title="' . sc_language_render('action.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
