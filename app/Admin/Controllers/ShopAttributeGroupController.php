...
public function edit($id)
{
    ...
    $data = [
        'title' => trans('attribute_group.admin.list'),
        'title_action' => '<i class="fa fa-pencil-square-o" aria-hidden="true"></i> ' . trans('attribute_group.admin.edit'),
        'subTitle' => '',
        'icon' => 'fa fa-indent',
        'urlDeleteItem' => route('admin_attribute_group.delete'),
        'removeList' => 0, // 1 - Enable function delete list item
        ...
        'css' => '', 
        'js' => '',
        'url_action' => route('admin_attribute_group.edit', ['id' => $attribute_group['id']]),
