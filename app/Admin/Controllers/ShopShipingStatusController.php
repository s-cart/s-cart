...
public function edit($id)
{
    ...
    $data = [
        'title' => trans('shipping_status.admin.list'),
        'title_action' => '<i class="fa fa-pencil-square-o" aria-hidden="true"></i> ' . trans('shipping_status.admin.edit'),
        'subTitle' => '',
        'icon' => 'fa fa-indent',
        'urlDeleteItem' => route('admin_shipping_status.delete'),
        'removeList' => 0, // 1 - Enable function delete list item
        ...
        'css' => '', 
        'js' => '',
        'url_action' => route('admin_shipping_status.edit', ['id' => $shipping_status['id']]),
